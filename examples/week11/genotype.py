...
def develop(genotype: Genotype) -> ModularRobot:
    ...
    body.core.front.attachment.left = ActiveHinge(math.pi / 2.0)
    body.core.front.attachment.left.attachment = Brick(0.0)

    body.core.front.attachment.right = ActiveHinge(math.pi / 2.0)
    ...
    body.core.back._absolute_rotation = math.pi / 2.0

    body.core.back.attachment.left = ActiveHinge(0)
    body.core.back.attachment.left._absolute_rotation = 0
    body.core.back.attachment.left.attachment = Brick(0.0)

    body.core.back.attachment.right = ActiveHinge(0)
